...
class TurbomindEngineConfig:
    ...
    def __post_init__(self):
        ...
        assert self.num_draft_tokens >= 0, 'num_draft_tokens must be >= 0'
        # Auto-enable speculative decoding when num_draft_tokens > 0
        if self.num_draft_tokens > 0 and not self.speculative_decoding:
