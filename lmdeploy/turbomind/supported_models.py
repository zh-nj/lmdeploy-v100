...
SUPPORTED_ARCHS = dict(
    ...
    # Qwen3.5 VL MoE (GDN + MoE hybrid)
    Qwen3_5MoeForConditionalGeneration='qwen3-5-vl-moe',
    # Qwen3.5 dense (GDN + dense FFN)
    Qwen3_5ForConditionalGeneration='qwen3-5-vl-dense',
    # Qwen3-VL-MoE
    Qwen3VLMoeForConditionalGeneration='qwen3-vl-moe',
    # Qwen3-Coder-Next
    Qwen3NextForCausalLM='qwen3-coder-next',
    # Step-3.5-Flash
            ...
            if arch == 'BaichuanForCausalLM':
                ...
                if text_cfg:
                    if isinstance(text_cfg, dict):
                        ...
                        if head_dim is None:
                            head_dim = text_cfg.hidden_size // text_cfg.num_attention_heads
                    support_by_turbomind = head_dim in [64, 128, 256]
