...
class Qwen3VLMoeReader(Qwen3MoeReader):
    """Reader for Qwen3VLMoe - remaps model.language_model.layers.{i}
    prefix."""
...
@INPUT_MODELS.register_module(name='qwen3-vl-moe')
class Qwen3VLMoeModel(Qwen3MoeModel):
    """Qwen3VLMoe model - VL wrapper around qwen3-moe text backbone."""
