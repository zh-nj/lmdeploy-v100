...
Supported models:</br>
Qwen3.5-122B-A10B-AWQ-4bit, Qwen3.5-35B-A3B-AWQ, Qwen3.5-27B-AWQ-4bit, Qwen3.5-9B-AWQ-4bit, Qwen3.5-4B-AWQ-4bit, Qwen3.5-2B, Qwen3.5-0.8B <b>(multimodal with video support, MTP)</b></br>
MiniMax-M2.5-AWQ, MiniMax-M2.1-AWQ</br>
Step-3.5-Flash-int4-mixed-AutoRound (MTP supported), Step-3.5-Flash-AWQ-4bit (this model does not include MTP layers)</br>
Qwen3-Coder-Next-AWQ-4bit, Qwen3-Next-80B-A3B-Thinking-AWQ-4bit</br>
New features:</br>
Anthropic API</br>
AutoRound & compressed-tensors quantization support</br>
GGUF support (in progress)</br>
